...
import 'package:mpmed_doctor/authOtp/pages/splash_page.dart';
import 'package:mpmed_doctor/config/config.dart';
    ...
    switch (data['click_action']) {
      case "review_screen":
        navigatorKey.currentState!.pushNamedAndRemoveUntil(
            ...
            (route) => route.settings.name == DocumentItemScreen.routeName
                ? false
                : true,
      ...
      case "question_screen":
        navigatorKey.currentState!.pushNamedAndRemoveUntil(
            ...
            (route) => route.settings.name == QuestionItemScreen.routeName
                ? false
                : true,
            arguments: data['arguments']);
        break;
      case "documents_screen":
        navigatorKey.currentState!.pushNamedAndRemoveUntil(
            ...
            (route) =>
                route.settings.name == DocumentsScreen.routeName ? false : true,
            arguments: data['arguments']);
        break;
    }
    return;
