...
class _DoctorItemScreenState extends State<DoctorItemScreen> {
  ...
  Future _obtainWorkingHoursFuture() async {
    return Provider.of<DoctorsListProvider>(context, listen: false)
        .fetchAndSetWorkingHours(widget.profile!.nationalCode.toString());
  }
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          CircleAvatar(
                            radius: 70,
                            backgroundImage: NetworkImage(widget.profile!.profilePic.toString()),
                          ),
                          SizedBox(
                            height: 30,
                          ),
                                                  ...
                                                  child: doctorsData
                                                      ...
                                                      : Center(
                                                          child: GlassContainer(
                                                            ...
                                                            child: Center(
                                                              child: Text(
                                                                  'این پزشک ساعت کاری خود را وارد نکرده است',style: TextStyle(
                                                                      fontSize:
                                                                          16,
                                                                      fontWeight:
                                                                          FontWeight
