...
import 'package:mpmed_doctor/authOtp/form_validator.dart';
import 'package:mpmed_doctor/authOtp/sign_up_data.dart';
    ...
    return new Column(
      children: <Widget>[
                ...
                ? Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("تصویر حساب کاربری انتخاب نشده است"),
                      ),
                    ],
                  )
                : Image.file(_image!),
        ...
        _TextReciver("شماره موبایل", "mobile", TextInputAction.next,
            TextInputType.phone, _mobileFocusNode, _specialtyFocusNode),
        new SizedBox(height: 15.0),
        _TextReciver("تخصص", "specialty", TextInputAction.next,
            TextInputType.text, _specialtyFocusNode, _mdcodeFocusNode),
        new SizedBox(height: 15.0),
        _TextReciver("کد نظام پزشکی", "md_code", TextInputAction.done,
            TextInputType.number, _mdcodeFocusNode, null as FocusNode),
        FlatButton(
        ...
        CheckboxListTile(
          ...
          title: Padding(
            ...
            child: Text('تجربه کار کردن با اپلیکیشن های پزشکی را دارم'),
          ),
        ),
